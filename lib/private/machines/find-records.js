...
module.exports = {
  ...
  fn: function (inputs, exits) {
    ...
    if (s3q.meta && s3q.meta.logMongoS3Qs) {
      console.log('* * * * * *\nADAPTER (FIND RECORDS):',util.inspect(s3q,{depth:10}),'\n');
    }
    ...
    // if (s3q.meta && s3q.meta.logMongoS3Qs) {
    //   console.log('mongoWhere',util.inspect(mongoWhere,{depth:10}));
    //   console.log('mongoWhere["$and"] && typeof mongoWhere["$and"][0].driver_taxis.in[0]',util.inspect(mongoWhere['$and'] && typeof mongoWhere['$and'][0].driver_taxis.$in[0],{depth:10}));
    // }
    ...
    mongoDeferred.toArray(function findCb(err, nativeResult) {
      ...
      // if (s3q.meta && s3q.meta.logMongoS3Qs) {
      //   console.log('found %d records',phRecords.length, util.inspect(phRecords,{depth:10}),'\n');
      // }
